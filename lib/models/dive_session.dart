class DiveSession {
  ...
  factory DiveSession.fromMap(Map<String, dynamic> map) => DiveSession(
    id: map['id'] as String,
    userId: map['userId'] as String,
    cliente: map['cliente'] as String,
    operadoraBuceo: map['operadoraBuceo'] as String,
    direccionOperadora: map['direccionOperadora'] as String,
    lugarBuceo: map['lugarBuceo'] as String,
    tipoBuceo: map['tipoBuceo'] as String,
    nombreBuzos: (map['nombreBuzos'] as String).split(','),
    supervisorBuceo: map['supervisorBuceo'] as String,
    estadoMar: map['estadoMar'] as int,
    visibilidad: (map['visibilidad'] as num).toDouble(),
    temperaturaSuperior: (map['temperaturaSuperior'] as num).toDouble(),
    temperaturaAgua: (map['temperaturaAgua'] as num).toDouble(),
    corrienteAgua: map['corrienteAgua'] as String,
    tipoAgua: map['tipoAgua'] as String,
    horaEntrada: DateTime.parse(map['horaEntrada'] as String),
    maximaProfundidad: (map['maximaProfundidad'] as num).toDouble(),
    tiempoIntervaloSuperficie: (map['tiempoIntervaloSuperficie'] as num).toDouble(),
    tiempoFondo: (map['tiempoFondo'] as num).toDouble(),
    inicioDescompresion: map['inicioDescompresion'] != null ? DateTime.parse(map['inicioDescompresion'] as String) : null,
    descompresionCompleta: map['descompresionCompleta'] != null ? DateTime.parse(map['descompresionCompleta'] as String) : null,
    tiempoTotalInmersion: (map['tiempoTotalInmersion'] as num).toDouble(),
    horaSalida: DateTime.parse(map['horaSalida'] as String),
    descripcionTrabajo: map['descripcionTrabajo'] as String,
    descompresionUtilizada: map['descompresionUtilizada'] as String,
    enfermedadLesion: map['enfermedadLesion'] as String?,
    tiempoSupervisionAcumulado: (map['tiempoSupervisionAcumulado'] as num).toDouble(),
    tiempoBuceoAcumulado: (map['tiempoBuceoAcumulado'] as num).toDouble(),
